## Unit 3, Assignment 18 - CMU Graphics 2.5.4 and Interactive Image Task Progress
Due: Wednesday, December 3rd 2025

### CMU Graphics 2.5.4:
Complete [CMU Graphics](https://academy.cs.cmu.edu/) exercise set 2.5.4 (using multiple if-else and multiple ifs)
...
**At minimum**, add an if-else conditional to the body of your function that controls which block of code is run <b>based on an argument passed to a parameter.</b><br>

**Additionally, consider using this as an opportunity to...** <br>
* ...revisiting previous interactive image task progress assignments to ensure you are on track to completing the interactive image task by Friday, December 12th.
