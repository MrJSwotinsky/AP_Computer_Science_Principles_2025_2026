## Unit 3, Assignment 17- CMU Graphics 2.5.2 and Interactive Image Task Progress
Due: Tuesday, December 2nd 2025

### CMU Graphics 2.5.2:
Complete [CMU Graphics](https://academy.cs.cmu.edu/) exercise set 2.5.2 (if-else conditionals)
...
**At minimum**, add at least one if-else conditional to your code.<br>
